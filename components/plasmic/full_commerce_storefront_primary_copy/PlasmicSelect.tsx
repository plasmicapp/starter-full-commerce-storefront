...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: c9gzu10Sl_YEGD/component
import Select__Option from "../../Select__Option"; // plasmic-import: 3bJg4x5LewUFh1/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: 2oCjVviAPyxsxg/css

import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: k1GzKyJqhV1PKe/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: IIYRexCzSy2MrH/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__vKuyt)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__jp2Jn)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
