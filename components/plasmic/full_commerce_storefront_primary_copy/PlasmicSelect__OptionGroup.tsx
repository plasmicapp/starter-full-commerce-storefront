...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 5AFiRq5dP7g57V/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 2oCjVviAPyxsxg/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__lsCaj)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__eqmsR)}
              />
            </React.Fragment>
          ),
          value: args.children
